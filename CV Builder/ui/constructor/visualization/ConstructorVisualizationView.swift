//
//  ConstructorVisualizationView.swift
//  CV Builder
//
...
struct ConstructorVisualizationView: View {
    
    @Environment(\.presentationMode) var presentationMode
    
    @EnvironmentObject var parentViewModel: ConstructorViewModel
    @StateObject var viewModel = ConstructorVisualizationViewModel()
...
#Preview {
    ConstructorVisualizationView().environmentObject(ConstructorViewModel())
}
