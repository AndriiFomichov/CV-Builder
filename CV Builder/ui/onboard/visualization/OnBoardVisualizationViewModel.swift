//
//  OnBoardVisualizationViewModel.swift
//  CV Builder
//
...
class OnBoardVisualizationViewModel: ObservableObject {
    ...
    @Published var consentWindowShown = false
    ...
    func updateData (parentViewModel: OnBoardViewModel) {
        ...
        getData()
        AnalyticsManager.saveEvent(event: Events.ONBOARD_VISUALIZATION_OPENED)
