...
struct CertificateDropDelegate: DropDelegate {
    
    let destinationItem: CertificateItem?
    @Binding var list: [CertificateItem]
    @Binding var draggedItem: CertificateItem?
...
//         Swap Items
    ...
    private func getIndexOfItem (item: CertificateItem?) -> Int? {
        if let item {
