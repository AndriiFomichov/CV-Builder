...
struct InterestDropDelegate: DropDelegate {
    
    let destinationItem: InterestItem?
    @Binding var list: [InterestItem]
    @Binding var draggedItem: InterestItem?
...
//         Swap Items
    ...
    private func getIndexOfItem (item: InterestItem?) -> Int? {
        if let item {
