...
struct ReferenceDropDelegate: DropDelegate {
    
    let destinationItem: ReferenceItem?
    @Binding var list: [ReferenceItem]
    @Binding var draggedItem: ReferenceItem?
...
//         Swap Items
    ...
    private func getIndexOfItem (item: ReferenceItem?) -> Int? {
        if let item {
