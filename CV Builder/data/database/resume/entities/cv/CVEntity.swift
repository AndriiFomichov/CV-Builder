...
class CVEntity {
    ...
    init(entity: CVEntity) {
        ...
        self.targetJob = entity.targetJob
        self.targetCompany = entity.targetCompany
        self.targetJobDescription = entity.targetJobDescription
